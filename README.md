...
3. **業種を問わない一般デザイン原則**（`references/general-design-principles.md`）— 近接・整列・強弱・反復、配色比率、タイポグラフィ基本、モーションの節度、UIライティング、計画→レビュー→実装→批評の進め方。Anthropicの`frontend-design` Skillと一般的なWebデザイン解説記事を参考に構成
